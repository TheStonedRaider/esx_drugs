...
--coke
  ['coke_pickupprompt'] = 'press ~INPUT_CONTEXT~ to harvest the ~g~Coke~s~ plant.',
  ['coke_inventoryfull'] = 'you do not have any more inventory space for ~g~Coke leaves~s~.',
  ['coke_processprompt'] = 'press ~INPUT_CONTEXT~ to start ~g~Process Coke~s~.',
  ['coke_processingstarted'] = 'processing ~g~Coke leaves~s~ into ~g~Coke bag~s~...',
  ['coke_processingfull'] = 'processing ~r~canceled~s~ due to full inventory!',
  ['coke_processingenough'] = 'you must have ~b~3x~s~ ~g~Coke leaves~s~ in order to process.',
  ['coke_processed'] = 'you\'ve processed ~b~3x~s~ ~g~Coke leaves~s~ to ~b~1x~s~ ~g~Coke bag~s~',
  ...
  -- license
  ['license_title'] = 'you are required to pay a fee to process this product, you can pay here.',
  ['license_no'] = 'no',
