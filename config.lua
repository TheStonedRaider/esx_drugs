...
Config.CircleZones = {
	...
	CokeField = {coords = vector3(310.91, 4290.87, 45.15), name = _U('blip_cokefield'), color = 25, sprite = 496, radius = 100.0},
	CokeProcessing = {coords = vector3(2329.02, 2571.29, 46.68), name = _U('blip_cokeprocessing'), color = 25, sprite = 496, radius = 100.0},
